export default function FAQ() {
	const faqs = [
		...
		},
		{
			...
			answer:
				'Доступ до навчальних матеріалів буде на протязі проходження курсу плюс ще один місяц після успішного проходження. Якщо ти вирішив завершити начання і не доходити до кінця програми - доступ закриваєтся до першого уроку наступного абонементу за який не було сплачено',
		},
	]
