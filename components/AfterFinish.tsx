		...
		<section className='py-20 px-6 bg-black text-white'>
			<div className='max-w-6xl mx-auto'>
				...
				<div className='grid md:grid-cols-2 gap-8'>
					{[
						'8 онлайн-уроків щомісяця у міні-групі, тривалістю 1–2 години',
						'Доступ до навчальної платформи з усіма записами, конспектами, нотами та вправами під час проходження курсу',
						'Авторські вправи, яких немає у відкритому доступі',
						'Перевірку домашніх завдань та фідбек у Telegram-чаті',
						'Повний супровід протягом 3 місяців',
