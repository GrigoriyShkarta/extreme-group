		...
		<section className='py-20 px-6 bg-black text-white'>
			<div className='max-w-6xl mx-auto'>
				...
				<div className='grid md:grid-cols-2 gap-8'>
					{[
						'4 онлайн-уроки щомісяця у міні-групі (4–6 людей), тривалістю 1–2 години',
						'Доступ до навчальної платформи з усіма записами, конспектами, нотами',
						...
						'Бонус: Ти не просто вчиш техніку — ти вчишся звучати, як артист',
					].map((item, index) => (
